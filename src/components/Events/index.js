...
class Events extends Component {
  state = {registrationStatus: 'NO_ACTIVE_EVENT'}

  handleEventClick = status => this.setState({registrationStatus: status})

  renderEventsList = () => (
    <div className="eventsList-container">
      <h1 className="eventsList-container-heading">Events</h1>
